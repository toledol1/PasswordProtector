<?php
	//////////////////////////////////////////////////
	//-------------Admin Request Page---------------//
	//When a moderator accesses this page it should //
	//only show users who have requested to be an   //
	//administrator for the website. Moderators can //
    ...
    $sql = $conn->prepare("SELECT userID, userName, firstName, lastName, accessLevel
            FROM User
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Password Protector|Admin Requests</title>
        ...
        <div class="row content" style="margin-top:5%" >
            <div class="col-xs-8 col-xs-offset-2">
                <div class="well" style="background:lightgray;padding-bottom:35px">
					<h4><strong>Open Admin Access Requests</strong></h4>
					<div class="row">
						<table id="siteTable">
							<thead>
								<tr>
