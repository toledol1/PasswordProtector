<?php
    ...
    $sql = $conn->prepare("SELECT userID, userName, firstName, lastName, numSitesAllowed, lastAccess
            FROM User
        ...
        <div class="row content" style="margin-top:5%" >
            <div class="col-xs-8 col-xs-offset-2">
                <div class="well" style="background:lightgray;padding-bottom:35px">
					<h4><strong>Manage User Accounts</strong></h4>
					<div class="row">
						<form action="manageUsers.php" method="post" name="fromManageUsers">
						<table id="siteTable">
							<thead>
								<tr>
									<th> ID </th>
					...
					<strong><a href="deleteUser.php" >Delete a User</a></strong>
					</form>
                </div>
            </div>
        </div>
