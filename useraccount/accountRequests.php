<?php
	...
	//page, it should ONLY show new users. Admin/Mod//
	//must approve the new user so they can add or  //
	//create password and save them in the database.//
	//////////////////////////////////////////////////
...
$isModorAdmin = ($_SESSION['rank'] >= '2' ? true : false);
    ...
    $statement = $conn->prepare("SELECT userID, userName, firstName, lastName, email, approved 
            FROM User
...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Password Protector|Account Requests</title>
        ...
        <div class="row content" style="margin-top:5%" >
            <div class="col-xs-8 col-xs-offset-2">
                <div class="well" style="background:lightgray;padding-bottom:35px">
                    <h4><strong>New Account Requests</strong></h4>
                    <div class="row">
						<!--table to show the database-->
                        <table id="siteTable">
                            <thead>
                                <tr>
									<!--<th>Approve/Deny </th> -->
                            ...
                            <tbody>
                                <?php
									...
									/*foreach($row as $r) {
                                        echo "<tr>";
										//echo "<td><input type=\"checkbox\" name=\"accept[]\" value=\"\" id=\"checkbox\"></td>";
